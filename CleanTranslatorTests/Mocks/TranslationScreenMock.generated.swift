...
// MARK: - TranslationScreenBusinessLogic

open class TranslationScreenBusinessLogicMock: TranslationScreenBusinessLogic, Mock {
    ...
    open func didRequestTranslate(_ request: TranslationScreenModels.Update.Request) {
        addInvocation(.m_didRequestTranslate__request(Parameter<TranslationScreenModels.Update.Request>.value(`request`)))
		let perform = methodPerformValue(.m_didRequestTranslate__request(Parameter<TranslationScreenModels.Update.Request>.value(`request`))) as? (TranslationScreenModels.Update.Request) -> Void
		perform?(`request`)
    }
    ...
    fileprivate enum MethodType {
        case m_didRequestTranslate__request(Parameter<TranslationScreenModels.Update.Request>)
        case m_didLoad

        static func compareParameters(lhs: MethodType, rhs: MethodType, matcher: Matcher) -> Matcher.ComparisonResult {
            switch (lhs, rhs) {
            case (.m_didRequestTranslate__request(let lhsRequest), .m_didRequestTranslate__request(let rhsRequest)):
        ...
        func intValue() -> Int {
            switch self {
            case let .m_didRequestTranslate__request(p0): return p0.intValue
            case .m_didLoad: return 0
            }
        }
        func assertionName() -> String {
            switch self {
            case .m_didRequestTranslate__request: return ".didRequestTranslate(_:)"
    ...
    public struct Verify {
        ...
        public static func didRequestTranslate(_ request: Parameter<TranslationScreenModels.Update.Request>) -> Verify { return Verify(method: .m_didRequestTranslate__request(`request`))}
    ...
    public struct Perform {
        ...
        public static func didRequestTranslate(_ request: Parameter<TranslationScreenModels.Update.Request>, perform: @escaping (TranslationScreenModels.Update.Request) -> Void) -> Perform {
            return Perform(method: .m_didRequestTranslate__request(`request`), performs: perform)
        }
...
open class TranslationScreenDataStoreProtocolMock: TranslationScreenDataStoreProtocol, Mock {
    public init(sequencing sequencingPolicy: SequencingPolicy = .lastWrittenResolvedFirst, stubbing stubbingPolicy: StubbingPolicy = .wrap, file: StaticString = #file, line: UInt = #line) {
        SwiftyMockyTestObserver.setup()
        self.sequencingPolicy = sequencingPolicy
        self.stubbingPolicy = stubbingPolicy
    ...
    public var modelId: String {
		get {	invocations.append(.p_modelId_get); return __p_modelId ?? givenGetterValue(.p_modelId_get, "TranslationScreenDataStoreProtocolMock - stub value for modelId was not defined") }
	}
	private var __p_modelId: (String)?
    ...
    fileprivate enum MethodType {
        ...
        static func compareParameters(lhs: MethodType, rhs: MethodType, matcher: Matcher) -> Matcher.ComparisonResult {
            switch (lhs, rhs) {            case (.p_modelId_get,.p_modelId_get): return Matcher.ComparisonResult.match
            }
        }

        func intValue() -> Int {
            switch self {
            case .p_modelId_get: return 0
            }
        }
        func assertionName() -> String {
            switch self {
            case .p_modelId_get: return "[get] .modelId"
            }
        }
    }
    ...
    open class Given: StubbedMethod {
        ...
        public static func modelId(getter defaultValue: String...) -> PropertyStub {
            return Given(method: .p_modelId_get, products: defaultValue.map({ StubProduct.return($0 as Any) }))
        }
    ...
    public struct Verify {
        ...
        public static var modelId: Verify { return Verify(method: .p_modelId_get) }
    }
